...
function BotsPage() {
  ...
  return (
    <div>
      <YourBotArmy botArmy={botArmy} removeBot={dischargeBot} dischargeBot={releaseBotFromArmy} />
      <BotCollection bots={bots} addBot={addBotToArmy} dischargeBot={releaseBotFromArmy} />
    </div>
  )
}
